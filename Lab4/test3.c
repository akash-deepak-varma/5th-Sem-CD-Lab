...
void printParsingTable() {
    ...
    // First row
    printf("S\t"); // Print the row label
    printf("ACB\t"); // Print value under column 'a'
    printf("-\t");  // Print value under column 'b'
    printf("-\t");  // Print value under column 'c'
    printf("-\n");  // Print value under column '$' and move to the next line
    
    // Second row
    printf("A\t");  // Print the row label
    printf("aA\t"); // Print value under column 'a'
    printf("-\t");  // Print value under column 'b'
    printf("$\t");  // Print value under column 'c'
    printf("-\n");  // Print value under column '$' and move to the next line
    
    // Third row
    printf("B\t");  // Print the row label
    printf("-\t");  // Print value under column 'a'
    printf("bB\t"); // Print value under column 'b'
    printf("-\t");  // Print value under column 'c'
    printf("$\n");  // Print value under column '$' and move to the next line
    
    // Fourth row
    printf("C\t");  // Print the row label
    printf("-\t");  // Print value under column 'a'
    printf("-\t");  // Print value under column 'b'
    printf("c\t");  // Print value under column 'c'
    printf("-\n");  // Print value under column '$' and move to the next line
    printf("\n");
}
